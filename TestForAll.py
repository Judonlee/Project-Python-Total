...
if __name__ == '__main__':
    ...
    enc_vocab, enc_reverse_vocab, enc_vocab_size = build_vocab(
        all_input_sentences)  # enc_vocab:word2idx,enc_reverse_vacab:idx2word,enc_vocab_size:26
    dec_vocab, dec_reverse_vocab, dec_vocab_size = build_vocab(all_target_sentences,
                                                               is_target=True)  ##dec_vocab:word2idx,dec_reverse_vacab:idx2word,dec_vocab_size:28
    # print(enc_reverse_vocab)
    # exit()
    # hyperParameters
    n_epoch = 2000
    hidden_size = 50
        ...
        for epoch in range(n_epoch):
            ...
            for input_batch, target_batch in zip(input_batches, target_batches):
                ...
                for input_sent in input_batch:
                    input_sent, sent_len = sent2idx(input_sent, vocab=enc_vocab,
                                                    max_sentence_length=enc_sentence_length)
