...
if __name__ == '__main__':
    for appoint in range(10):
        savepath = 'E:/LIDC/Npy/OriginCsv/Appoint-%d/' % appoint
        os.makedirs(savepath)
        trainData, trainLabel, testData, testLabel = LIDC_Loader(nodulePath='E:/LIDC/LIDC-Nodules-Selected/',
                                                                 nonNodulePath='E:/LIDC/LIDC-NonNodules-CSV/',
                                                                 appoint=appoint)
