from MultiModalTest.Model.CTC_QuantumAttention import CTC_QuantumAttention
...
if __name__ == '__main__':
    ...
    for bands in [30, 40]:
        ...
        for session in range(1):
            savepath = 'E:/ProjectData_SpeechRecognition/IEMOCAP-Quantum/Bands%d/Session%d/' % (bands, session)
            ...
            with graph.as_default():
                classifier = CTC_QuantumAttention(trainData=trainData, trainLabel=trainLabel, trainSeqLength=trainSeq,
