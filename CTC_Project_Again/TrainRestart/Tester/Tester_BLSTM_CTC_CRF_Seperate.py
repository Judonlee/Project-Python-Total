...
import os
# from tensorflow.contrib import a
...
if __name__ == '__main__':
    ...
    for bands in [30]:
        for session in range(1, 2):
            ...
            netpath = 'D:/ProjectData/Determination/CRF-Seperate/Bands-%d-Session-%d/' % (bands, session)

            savepath = 'D:/ProjectData/Determination/Result-CRF-Seperate/Bands-%d-Session-%d/' % (
                bands, session)
