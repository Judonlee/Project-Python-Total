...
if __name__ == '__main__':
    ...
    for appoint in range(2):
        loadpath = 'D:/ProjectData/Project-CTC-Data/Records-CRF-Attention-WA/Bands-' + str(bands) + '-' + str(
            appoint) + '/'
        savepath = 'D:/ProjectData/Project-CTC-Data/Records-Result-CRF-Attention-WA/Bands-' + str(bands) + '-' + str(
            appoint) + '/'
        ...
        for episode in range(100):
            ...
            with graph.as_default():
                classifier = CRF_BLSTM_Attention(trainData=trainData, trainLabel=trainSeqLabel,
                                                 trainSeqLength=trainSeqLabel, featureShape=bands, numClass=4,
