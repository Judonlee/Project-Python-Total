...
class CTC_BLSTM(NeuralNetwork_Base):
    ...
    def BuildNetwork(self, learningRate):
        ...
        self.parameters['RNN_BatchNormalization'] = tensorflow.layers.batch_normalization(
            inputs=self.parameters['RNN_Concat'], name='RNN_BatchNormalization')

        ###################################################################################################
        # Logits
        ###################################################################################################

        self.parameters['RNN_Reshape'] = tensorflow.reshape(tensor=self.parameters['RNN_BatchNormalization'],
