...
class CTC_BLSTM(CTC):
    ...
    def BuildNetwork(self, learningRate):
        ...
        self.learningRateInput = tensorflow.placeholder(dtype=tensorflow.float32, shape=None, name='learningRateInput')
        ...
        self.train = tensorflow.train.RMSPropOptimizer(learning_rate=self.learningRateInput).minimize(
    ...
    def Train(self, learningRateDecay=0.98):
        ...
        while startPosition < len(trainData):
            ...
            loss, _ = self.session.run(fetches=[self.parameters['Cost'], self.train],
                                       feed_dict={self.dataInput: batchData,
                                                  ...
                                                  self.learningRateInput: self.learningRate})
            totalLoss += loss
        ...
        self.learningRate = self.learningRate * learningRateDecay
        return totalLoss
