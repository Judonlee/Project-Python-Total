...
class CTC_BLSTM(CTC):
    ...
    def BuildNetwork(self, learningRate):
        ...
        self.parameters['Logits'] = tensorflow.layers.dense(inputs=self.parameters['RNN_Reshape'],
                                                            units=self.numClass,
                                                            activation=None)
        ...
        self.parameters['Append'] = tensorflow.layers.dense(inputs=self.dataInput, units=1,
                                                            name='HHYYHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH')
