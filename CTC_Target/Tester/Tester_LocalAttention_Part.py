...
if __name__ == '__main__':
    ...
    for session in range(1, 6):
        for gender in ['Female', 'Male']:
            savepath = 'Result-CTC-LA-%d/Bands-%d-Session-%d-%s/' % (localAttentionScope, bands, session, gender)
            ...
            for episode in range(100):
                ...
                with graph.as_default():
                    ...
                    matrixDecode, matrixLogits, matrixSoftMax = classifier.Test_AllMethods(testData=trainData,
