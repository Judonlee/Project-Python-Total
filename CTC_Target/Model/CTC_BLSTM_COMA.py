...
class CTC_COMA_Attention(CTC_LC_Attention):
    def __init__(self, trainData, trainLabel, trainSeqLength, featureShape, numClass, rnnLayers, attentionScope,
        ...
        super(CTC_COMA_Attention, self).__init__(trainData=trainData, trainLabel=trainLabel,
                                                 trainSeqLength=trainSeqLength, featureShape=featureShape,
                                                 numClass=numClass, rnnLayers=rnnLayers, attentionScope=attentionScope,
                                                 hiddenNodules=hiddenNodules, batchSize=batchSize,
