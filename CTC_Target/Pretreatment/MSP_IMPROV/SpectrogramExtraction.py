...
if __name__ == '__main__':
    ...
    savepath = 'D:/ProjectData/MSP-IMPROVE/Voice-Features/Bands-%d/' % m_bands
    ...
    for indexA in os.listdir(loadpath):
        for indexB in os.listdir(os.path.join(loadpath, indexA)):
            for indexC in os.listdir(os.path.join(loadpath, indexA, indexB)):
                ...
                for indecD in os.listdir(os.path.join(loadpath, indexA, indexB, indexC)):
                    print(indexA, indexB, indexC, indecD)
                    y, sr = librosa.load(os.path.join(loadpath, indexA, indexB, indexC, indecD), sr=16000)
                    ...
                    file = open(os.path.join(savepath, indexA, indexB, indexC, indecD + '.csv'), 'w')
