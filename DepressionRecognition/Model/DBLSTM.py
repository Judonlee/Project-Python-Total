...
class DBLSTM(NeuralNetwork_Base):
    def __init__(self, trainData, trainLabel, trainSeq, featureShape=40, firstAttention=None, secondAttention=None,
                 firstAttentionShape=None, secondAttentionShape=None, firstAttentionName=None, secondAttentionName=None,
        ...
        self.firstAttentionShape, self.secondAttentionShape = firstAttentionShape, secondAttentionShape
    ...
    def Valid(self):
        ...
        result = self.session.run(fetches=self.parameters['First_FinalOutput'],
